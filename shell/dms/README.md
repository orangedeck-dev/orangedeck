...
Copy this directory to `~/.config/DankMaterialShell/plugins/OrangeDeck` and
enable the plugin in the DMS settings.
...
DMS. Language follows the system (13 languages), currency defaults to USD.
...
Parts of this plugin were written with AI assistance. Every line was reviewed
and tested by the author, who stands behind all of it.
